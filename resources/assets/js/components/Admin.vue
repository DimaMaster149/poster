                    ...
                    <div class="admin-form">
                        <form @submit="adminStore" enctype="multipart/form-data" >
                            ...
                            <div class="form-group">
                                ...
                                <date-picker class="form-control" name="event_date" placeholder="2018-10-25"
    ...
    export default {
        ...
        methods: {
            ...
            addEvent(event){
                ...
                let street = address[1];
                let house = address[2];
                let query = `https://nominatim.openstreetmap.org/search?q=${city}+${street}+${house}&format=json&polygon=1&addressdetails=1`;                let instance = currentObj.axios.create();
                delete instance.defaults.headers.common['X-CSRF-TOKEN'];
                delete instance.defaults.headers.common['X-Requested-With'];
                instance({
                    method: 'get',
